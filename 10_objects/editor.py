...
class Editor:
    def __init__ (self, land_tiles, switch):
        ...
        # clouds
        self.current_clouds = []
        self.cloud_surf = import_folder(r"Mario Maker Game\graphics\clouds")
        ...
        self.foregound = pygame.sprite.Group()
        ...
        CanvasObject(
            ...
            tile_id = 0, 
            origin = self.origin, 
            group = [self.canvas_objects, self.foregound])
        ...
        # music 
        self.editor_music = pygame.mixer.Sound(r"Mario Maker Game\audio\Explorer.ogg")
   ...
   # support 
    ...
    def imports(self):
        ...
        self.sky_handle_surf = load(r"Mario Maker Game\graphics\cursors\handle.png").convert_alpha()
        ...
        if mouse_buttons()[0] and not self.menu.rect.collidepoint(mouse_pos()) and not self.object_drag_active:
            ...
            if EDITOR_DATA[self.selection_index]['type'] == 'tile':
                ...
                if not self.object_timer.active:
                    groups = [self.canvas_objects, self.background] if EDITOR_DATA[self.selection_index]['style'] == 'palm_bg' else [self.canvas_objects, self.foregound]
                    CanvasObject(
                        pos = mouse_pos(),
    ...
    def draw_level(self):
        ...
        for cell_pos, tile in self.canvas_data.items():
            ...
            if tile.enemy:
                ...
                self.display_surface.blit(surf, rect)
        self.foregound.draw(self.display_surface)
